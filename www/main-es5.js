...
var config = { url: _environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].url, options: {} };
...
var ChatPage = /** @class */ (function () {
    function ChatPage(modal, navparams, loadingController) {
...
var ChatAdminPage = /** @class */ (function () {
    function ChatAdminPage(ptl, modals, modal, modalService, chatService, usuarioService, camera, localNotifications, alertController, actionSheerCtrl, loadingCtrl, fileChoosere, filePath, toastController, documentViewer, chooser, iOSFilePicker, fileOpener, docPicker) {
        this.ptl = ptl;
        this.modals = modals;
        this.modal = modal;
    ...
    ChatAdminPage.prototype.closeChat = function () {
        this.modal.dismiss();
        localStorage.setItem('grupo', localStorage.getItem('0000'));
        localStorage.setItem('nombreGpo', localStorage.getItem('0000'));
    };
    ChatAdminPage.prototype.ngOnInit = function () {
        var _this = this;
        // this.backgroundMode.enable();
        this.chatService.getEscribiendo().subscribe(function (esc) {
            _this.mensajeNew = document.getElementById(esc.toString());
            //  console.log(this.mensajeNew.id + 1);
            _this.span = document.getElementById(_this.mensajeNew.id + 1);
            _this.span.className = 'chat_date text-success';
            setTimeout(function () {
                _this.span.className = 'chat_date text-success hidden';
            }, 1000);
            if (_this.span !== null) {
                _this.ecribiendo = 'escr';
        ...
        this.chatService.getMessages().subscribe(function (msg) {
            var grupo = msg['grupo'];
            if (_this.mensajeNew == null) {
                return;
            }
            else {
                _this.mensajeNew = document.getElementById(grupo['_id']);
                ///////// Llamar la notificacion de un nuevo mensaje
            }
        });
        /////////////////////////////////////
        this.usuarioService.traerGruposUsuario(localStorage.getItem('email')).subscribe(function (resp) {
            if (resp['ok']) {
                var usuarioStorage = resp['usuario'];
                _this.grupos = usuarioStorage['grupos'];
        ...
        this.chatService.oldMessages(localStorage.getItem('grupo')).subscribe(function (msg) {
            _this.mensajes = msg['mensajes'];
            // console.log(this.mensajes);
            // Movimiento del scroll
            setTimeout(function () {
                _this.elemento.scrollTop = _this.elemento.scrollHeight;
    ...
    ChatAdminPage.prototype.newMessage = function () {
    ...
    ChatAdminPage.prototype.ngOnDestroy = function () {
        this.mensajesSubscription.unsubscribe();
    };
    // ENVIO DE MENSAJE  A TRAVES DE LA VARIABLE MSGG
    ChatAdminPage.prototype.enviar = function () {
        var grp = localStorage;
        var q = grp['grupo'];
    ...
    ChatAdminPage.prototype.procesarImagen = function (options) {
        var _this = this;
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.chatService.subirImagen(imageData);
            // NOS AYUDA A ENCONTRAR LOS USUARIOS DE EL GRUPO AL QUE ENVIAMOS
            _this.usuarioService.buscarUsuarios(localStorage.getItem('grupo'));
    ...
    ChatAdminPage.prototype.open = function () {
        this.fileOpener.open(this.returnpath, 'application/pdf');
    };
    // FileChooser IOS
    ChatAdminPage.prototype.fileChooseriOS = function () {
        var _this = this;
        this.chooser.getFile().then(function (value) {
            _this.filePath.resolveNativePath(value.uri).then(function (resolveNativePath) {
                _this.returnpath = resolveNativePath;
                console.log('AQUI:: ::: ::: ::: :::: >>>>>' + _this.returnpath);
    ...
    ChatAdminPage.prototype.fileChooser = function () {
        var _this = this;
        this.fileChoosere.open().then(function (fileuri) {
            _this.filePath.resolveNativePath(fileuri).then(function (resolveNativePath) {
                _this.returnpath = resolveNativePath;
                console.log(_this.returnpath);
                // EXTRAEMOS SU TIPO DE ARCHIVO PARA VALIDAR
                var extension = _this.returnpath.substr(-3);
                // console.log(extension);
                if (extension !== 'pdf') {
                    _this.presentToast();
                }
                    ...
                    // SUBIMOS NUESTRO ARCHIVO CON SU PATH
                    _this.chatService.subirArchivo(_this.returnpath);
                }
            });
        }, function (err) {
            console.log(JSON.stringify(err));
    ...
    ChatAdminPage.prototype.presentToast = function () {
    ...
    ChatAdminPage.prototype.presentActionSheet = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(id);
                        this.chatService.mensajePorId(id).subscribe(function (resp) {
                            if (resp['ok']) {
                                var mensaje = resp['mensaje'][0];
                                _this.referencia = mensaje.texto;
                                if (mensaje.reenviar) {
                                    _this.usuarioRes = mensaje.reenviar;
                                }
                                else {
                                    _this.usuarioRes = mensaje.usuario;
                                }
                                _this.imagenRes = mensaje.img;
                                _this.idRes = mensaje._id;
                            }
                        });
                        return [4 /*yield*/, this.actionSheerCtrl.create({
                                ...
                                buttons: [{
                                        ...
                                        icon: 'send',
                                        handler: function () {
                                            _this.presentMensaje(_this.referencia);
                                        }
                                    },
                                    {
                                        text: 'Reenviar',
    ...
    ChatAdminPage.prototype.presentMensaje = function (referencia) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.respuesta = data.txtRespuesta;
                                        setTimeout(function () {
                                            _this.loading.dismiss();
                                            _this.enviarRespuesta();
                                        }, 1500);
                                        _this.presentLoading('Cargando');
                                    }
                                }
                            ]
                        })];
    ...
    ChatAdminPage.prototype.enviarRespuesta = function () {
    ...
    ChatAdminPage.prototype.reenviarMsj = function (id) {
        var _this = this;
        // console.log('ID OBTENER ' +id);
        this.chatService.obtenerUsuario().subscribe(function (resp) {
            if (resp['ok']) {
                _this.usuarioGrupos = resp['userDB']['grupos'];
                _this.id = resp['userDB']._id;
            }
        });
        this.chatService.mensajePorId(id).subscribe(function (resp) {
            if (resp['ok']) {
                ...
                _this.mensajeReenviar = mensaje.texto || '';
                _this.imagenReenviar = mensaje.img;
                // console.log('IMAGEN' + this.imagenReenviar);
                _this.documentoReenviar = mensaje.doc;
                // console.log('DOCUMENTO ' + this.documentoReenviar);
                if (mensaje.reenviar) {
                    _this.idRen = mensaje.reenviar;
                }
                else {
                    _this.idRen = mensaje.usuario;
                }
                _this.abrirModal(id);
            }
            else {
    ...
    ChatAdminPage.prototype.abrirModal = function (idGrup) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalService.create({
    ...
    ChatAdminPage.prototype.eliminar = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Si, Borrarlo',
                                    handler: function () {
                                        _this.chatService.eliminar(id).subscribe(function (resp) {
                                            _this.mensajes = [];
                                            if (resp['ok']) {
                                                _this.mensajes = resp['mensajes'];
                                            }
                                        });
                                    }
                                }
    ...
    ChatAdminPage.prototype.presentActionSheetImage = function (imgId, msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.chatService.mensajePorId(msgId).subscribe(function (resp) {
                            if (resp['ok']) {
                                var mensaje = resp['mensaje'][0];
                                _this.referencia = mensaje.texto;
                                if (mensaje.reenviar) {
    ...
    ChatAdminPage.prototype.presentLoading = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    ChatAdminPage.prototype.openImage = function (images) {
    ...
    ChatAdminPage.prototype.presentActionSheetDocument = function (docId, msgId, msgDoc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, this.actionSheerCtrl.create({
                                ...
                                buttons: [{
                                        ...
                                        icon: 'document',
                                        handler: function () {
                                            _this.chatService.dowloandOpenDocument(docId, msgDoc);
                                        }
                                    },
                                    {
                                        text: 'Responder',
    ...
    ChatAdminPage.prototype.presentActionSheetDocumentRecive = function (docId, msgId, msgDoc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ChatAdminPage.prototype.presentActionSheetMsgLlegada = function (msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ChatAdminPage.prototype.presentActionSheetImgLlegada = function (imgId, msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ChatAdminPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var ReenviaGrupoPage = /** @class */ (function () {
    function ReenviaGrupoPage(modal, chatService, navParams, usuarioService) {
        this.modal = modal;
        this.chatService = chatService;
        this.navParams = navParams;
        this.usuarioService = usuarioService;
    ...
    ReenviaGrupoPage_1 = ReenviaGrupoPage;
    ReenviaGrupoPage.prototype.openMyModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var myModal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ReenviaGrupoPage.prototype.ngOnInit = function () {
    };
    ReenviaGrupoPage.prototype.close = function () {
        this.modal.dismiss();
    };
    ReenviaGrupoPage.prototype.reenviar = function (id) {
        var _this = this;
        ...
        this.chatService.mensajePorId(id).subscribe(function (resp) {
            if (resp['ok']) {
                ...
                _this.imagenReenviar = mensaje.img;
                _this.documentoReenviar = mensaje.doc;
                console.log('DOCUMENTO 2 ' + _this.documentoReenviar);
                if (mensaje.reenviar) {
                    _this.idRen = mensaje.reenviar;
                }
                else {
    ...
    ReenviaGrupoPage.prototype.enviarGrupo = function () {
        for (var i = 0; i < this.userGrupos.length; i++) {
            var element = this.userGrupos[i];
            var payload = {
                texto: this.mensajeReenviar,
                img: this.imagenReenviar,
                doc: this.documentoReenviar,
    ...
    ReenviaGrupoPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var ChatService = /** @class */ (function () {
    function ChatService(wsService, usuarioService, http, router, fileTransfer, loadingCtrl, file, fileOpener, toastController) {
    ...
    ChatService.prototype.cargarToken = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, localStorage.getItem('token')];
                    case 1:
    ...
    ChatService.prototype.sendMessage = function (mensaje, idGrupo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/token", { headers: headers })
                            .subscribe(function (resp) {
                            if (resp['ok']) {
                                _this.usuario = resp['userDB'];
                                ...
                                _this.wsService.emit('mensaje', payload);
                            }
                            else {
    ...
    ChatService.prototype.emitOldMessages = function () {
        var payload = {
    ...
    ChatService.prototype.oldMessages = function (grupo) {
    ...
    ChatService.prototype.emitEscribiendo = function (grupo) {
        var payload = { grupo: grupo };
        this.wsService.emit('escribiendo', payload);
    };
    ChatService.prototype.getEscribiendo = function () {
        return this.wsService.listen('escribiendo');
    };
    ChatService.prototype.getMessages = function () {
        return this.wsService.listen('mensaje-nuevo');
    };
    ChatService.prototype.limpiarMensajes = function (mensajes) {
        mensajes = [];
    };
    ChatService.prototype.subirImagen = function (img) {
        var _this = this;
        var options = {
            fileKey: 'image',
            headers: {
    ...
    ChatService.prototype.subirArchivo = function (file) {
        ...
        var fileTransfer = this.fileTransfer.create();
        fileTransfer.upload(file, src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/mensajes/upload/file", options).then(function (data) {
            setTimeout(function () {
                _this.loading.dismiss();
                _this.emitGuardarImagen();
            }, 1500);
    ...
    ChatService.prototype.presentToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ChatService.prototype.dowloandOpenDocument = function (docId, msgDoc) {
        var _this = this;
        var fileTransfer = this.fileTransfer.create();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + '/mensajes/' + docId;
        console.log();
        console.log(url);
        fileTransfer.download(url, this.file.dataDirectory + msgDoc).then(function (entry) {
            console.log('DESCARGADO');
            var urll = entry.toURL();
            console.log(urll);
            _this.fileOpener.open(urll, 'application/pdf');
        }, function (error) {
            console.log(error);
            // handle error
        });
    ...
    */
    ...
    ChatService.prototype.presentLoading = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    // SUBE LA IMAGEN
    ChatService.prototype.guardarImagen = function (formData) {
        this.cargarToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-token': this.token
        });
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/mensajes/upload", formData, { headers: headers });
    };
    // CARGA LA IMAGEN
    ChatService.prototype.emitGuardarImagen = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/token", { headers: headers })
                            ...
                            if (resp['ok']) {
                                ...
                                _this.wsService.emit('imagen', payload);
                            }
                        });
                        return [2 /*return*/];
                }
    ...
    ChatService.prototype.mensajePorId = function (id) {
        this.cargarToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-token': localStorage.getItem('token')
        });
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/obtener/mensaje/" + id, { headers: headers });
    };
    // ENVIA LA RESPUES DEL MENSAJE....
    ChatService.prototype.emitRespuesta = function (idRes, respuesta, grupo) {
        var _this = this;
        this.cargarToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-token': localStorage.getItem('token')
        ...
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/token", { headers: headers })
            ...
            if (resp['ok']) {
                ...
                _this.wsService.emit('respuesta', payload);
            }
        });
    };
    // Obtiene los datos del usuario
    ChatService.prototype.obtenerUsuario = function () {
        this.cargarToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-token': this.token
        });
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/token", { headers: headers });
    };
    ChatService.prototype.sendReenviar = function (payload) {
        this.wsService.emit('reenviar', payload);
    };
    /* ELIMINAR */
    ChatService.prototype.eliminar = function (id) {
        this.cargarToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-token': this.token
        });
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + "/eliminado/" + id + "/" + localStorage.getItem('grupo'), { headers: headers });
    };
...
var PushService = /** @class */ (function () {
    function PushService(oneSignal, usuarioService) {
    ...
    PushService.prototype.configuracionInicial = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.oneSignal.getIds().then(function (info) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                this.userId = info.userId;
                                // Guarda el ID en el localstorage
                                return [4 /*yield*/, localStorage.setItem('idOnesignal', this.userId)];
                            case 1:
                                // Guarda el ID en el localstorage
                                _a.sent();
...
var UsuarioService = /** @class */ (function () {
    function UsuarioService(http, router, storage, navCtrl, platform) {
        this.http = http;
        this.router = router;
    ...
    UsuarioService.prototype.getPosts = function (pull) {
    ...
    UsuarioService.prototype.login = function (email, password) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + "/login", data)
                .subscribe(function (resp) {
                // console.log(resp);
                if (resp['ok']) {
                    //  console.log(resp);
    ...
    UsuarioService.prototype.enviaOneSignal = function (usuarioId) {
        var _this = this;
        var signal = {
            'onesignal': usuarioId
        };
        ...
        // console.log(signal);
        return new Promise(function (resolve) {
            _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + "/updateone", signal, { headers: headers }).subscribe(function (resp) {
                //    console.log(signal);
            });
        });
    };
    UsuarioService.prototype.checkUserType = function (email) {
        var _this = this;
        var data = { email: email };
        return new Promise(function (resolve) {
            _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + "/checkUserType", data).subscribe(function (resp) {
                //    console.log(resp['ok']);
                if (resp['ok']) {
                    resolve(true);
                }
    ...
    UsuarioService.prototype.buscarUsuarios = function (grupo) {
        var _this = this;
        ...
        return new Promise(function (resolve) {
            ...
            _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + "/buscarUsuarios", grupos).subscribe(function (resp) {
                //      console.log(resp);
            });
        });
    };
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.token = token;
                        return [4 /*yield*/, localStorage.setItem('token', token)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UsuarioService.prototype.guardarUtype = function (userType) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.userType = userType;
                        return [4 /*yield*/, localStorage.setItem('userType', userType)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                ...
                                _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].url + "/token", { headers: headers })
                                    .subscribe(function (resp) {
                                    if (resp['ok']) {
                                        _this.usuario = resp['userDB'];
                                        resolve(true);
    ...
    UsuarioService.prototype.traerGruposUsuario = function (email) {
        var data = { email: email };
...
var WebsocketService = /** @class */ (function () {
    function WebsocketService(socket, http, uServece) {
        this.socket = socket;
        this.http = http;
...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(pushService, aplicationRef, platform, splashScreen, usuarioService, chatService, modal, chat, chatAdminPage, navController, localNotifications) {
        this.pushService = pushService;
    ...
    Tab1Page.prototype.ngOnInit = function () {
        ...
        this.chatService.getMessages().subscribe(function (msg) {
            _this.grupo = msg['grupo'];
            _this.nombre = _this.grupo['nombre'];
            // nombre del grupo
            // console.log(this.nombre);
            if (_this.mensajeNuevo === null) {
                return;
            }
            else {
                _this.mensajeNuevo = document.getElementById(_this.grupo['_id']);
            }
            _this.newMessage();
        });
        /** ECRIBIENDO NOS AVISA CUANDO SE ESTA ESCRIBIENDO EN EL GRUPO */
        this.chatService.getEscribiendo().subscribe(function (esc) {
            _this.mensajeNuevo = document.getElementById(esc.toString());
            //  console.log(this.mensajeNuevo.id + 1);
            if (_this.mensajeNuevo == null) {
                return;
            }
            else {
                _this.span = document.getElementById(_this.mensajeNuevo.id + 1);
            }
    ...
    Tab1Page.prototype.openChat = function (grupo, nombreGrupo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var valido;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.usuarioService.checkUserType(localStorage.getItem('email'))];
                    case 1:
                        valido = _a.sent();
...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(modals, modal, modalService, chatService, usuarioService, camera, localNotifications, alertController, actionSheerCtrl, loadingCtrl) {
        this.modals = modals;
        this.modal = modal;
        this.modalService = modalService;
        this.chatService = chatService;
    ...
    Tab2Page.prototype.closeChat = function () {
        this.modal.dismiss();
        localStorage.setItem('grupo', localStorage.getItem('0000'));
        localStorage.setItem('nombreGpo', localStorage.getItem('0000'));
    };
    ...
    Tab2Page.prototype.newMessage = function () {
        if (this.mensajeNew.id !== localStorage.getItem['grupo']) {
            this.localNotifications.schedule([{
                    id: 2,
                    title: 'Nuevo Mensaje',
    ...
    // ENVIO DE MENSAJE  A TRAVES DE LA VARIABLE MSGG 
    Tab2Page.prototype.enviar = function () {
        var grp = localStorage;
        var q = grp['grupo'];
        if (this.msgg.trim().length === 0) {
            return;
    ...
    Tab2Page.prototype.escribir = function (event) {
        this.chatService.emitEscribiendo(localStorage.getItem('grupo'));
        //console.log(event);
    };
    /** ABRE LA GALERIA */
    Tab2Page.prototype.galeria = function () {
        var options = {
            quality: 70,
            destinationType: this.camera.DestinationType.FILE_URI,
            encodingType: this.camera.EncodingType.JPEG,
    ...
    //////////// METODO DE RESPONDER MENSAJE /////////////
    Tab2Page.prototype.presentActionSheet = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab2Page.prototype.presentActionSheetDocument = function (docId, msgId, msgDoc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab2Page.prototype.presentActionSheetDocumentRecive = function (docId, msgId, msgDoc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab2Page.prototype.presentMensaje = function (referencia) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    // Metodo de para enviar Respuesta
    Tab2Page.prototype.enviarRespuesta = function () {
        if (this.respuesta.trim().length === 0) {
            return;
        }
        this.chatService.emitRespuesta(this.idRes, this.respuesta, localStorage.getItem('grupo'));
    ...
    // Metodo que muestra grupos a Reenviar el mensaje
    Tab2Page.prototype.reenviarMsj = function (id) {
        var _this = this;
        this.chatService.obtenerUsuario().subscribe(function (resp) {
            if (resp['ok']) {
                _this.usuarioGrupos = resp['userDB']['grupos'];
    ...
    Tab2Page.prototype.abrirModal = function (idGrup) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    Tab2Page.prototype.eliminar = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    /// RESPONDE IMAGEN OPCIONES
    Tab2Page.prototype.presentActionSheetImage = function (imgId, msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab2Page.prototype.presentLoading = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    // Metodo para abrir imagen
    Tab2Page.prototype.openImage = function (images) {
        //  console.log('IMAGEN' + images);
        this.modals.create({
    ...
    /********************* OPCIONES PARA LOS MENSAJES DE LLEGADA*****************************/
    Tab2Page.prototype.presentActionSheetMsgLlegada = function (msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    Tab2Page.prototype.presentActionSheetImgLlegada = function (imgId, msgId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
